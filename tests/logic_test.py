...
class TestFunctions(unittest.TestCase):
    ...
    def test_generate_points(self):
        ...
        testpoints2 = generate_points(3, 10, 10, 2)
        self.assertLessEqual(testpoints[0][0], (95))
        self.assertLessEqual(testpoints[1][1], (95))
        self.assertGreater(distance(testpoints[0], testpoints[1]), 10)
        self.assertEqual(len(testpoints2), 3)
    ...
    def test_generate_rooms(self):  
        ...
        self.assertEqual(len(testrooms), 5)
    ...
    def test_pathing(self):
        ...
        self.assertEqual(len(testpath), 6)
